		...
		function checkSelected(mainClass,mainWidth){
				...
				$('.'+mainClass).each(function(){
					...
					$(this).find('span').each(function(){
						...
						if (spanClass == "passiveSelect" || spanClass == "active") $(this).remove();
...
$(document).ready(function() {
	$("#contactSelect1").styleSelect({styleClass: "contact-form-selectStyle"});
	$("#contactSelect2").styleSelect({styleClass: "contact-form-selectStyle"});
});